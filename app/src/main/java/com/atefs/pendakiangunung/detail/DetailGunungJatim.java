...
public class DetailGunungJatim extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        collapsingToolbar.setExpandedTitleTextAppearance(R.style.CollapsedAppBarr);
        int postion = getIntent().getIntExtra(EXTRA_POSITION, 0);
        Resources resources = getResources();
        String[] places = resources.getStringArray(R.array.nama_gunung_jatim);
        collapsingToolbar.setTitle(places[postion % places.length]);

        TypedArray imageGunung = resources.obtainTypedArray(R.array.image_gunung_jatim);
        ...
        String[] namaGunung = resources.getStringArray(R.array.nama_gunung_jatim);
        TextView namagunung = (TextView) findViewById(R.id.nama_gunung);
        namagunung.setText(namaGunung[postion % namaGunung.length]);

        String[] detailGunung = resources.getStringArray(R.array.deskripsi_gunung_jatim);
        ...
        String[] jalurGunung = resources.getStringArray(R.array.jalur_jatim);
        TextView jalurgunung = (TextView) findViewById(R.id.jalur);
        jalurgunung.setText(jalurGunung[postion % jalurGunung.length]);

        String[] informasiGunung = resources.getStringArray(R.array.nama_gunung_jatim);
        ...
        String[] detailInformasi = resources.getStringArray(R.array.informasi_gunung_jatim);

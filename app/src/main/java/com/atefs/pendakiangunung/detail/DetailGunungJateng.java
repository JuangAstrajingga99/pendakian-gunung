...
public class DetailGunungJateng extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        String[] places = resources.getStringArray(R.array.nama_gunung_jateng);
        collapsingToolbar.setTitle(places[postion % places.length]);

        TypedArray imageGunung = resources.obtainTypedArray(R.array.image_gunung_jateng);
        ...
        String[] namaGunung = resources.getStringArray(R.array.nama_gunung_jateng);
        TextView namagunung = (TextView) findViewById(R.id.nama_gunung);
        namagunung.setText(namaGunung[postion % namaGunung.length]);

        String[] detailGunung = resources.getStringArray(R.array.deskripsi_gunung_jateng);
        ...
        String[] jalurGunung = resources.getStringArray(R.array.jalur_jateng);
        TextView jalurgunung = (TextView) findViewById(R.id.jalur);
        jalurgunung.setText(jalurGunung[postion % jalurGunung.length]);

        String[] informasiGunung = resources.getStringArray(R.array.nama_gunung_jateng);
        ...
        String[] detailInformasi = resources.getStringArray(R.array.informasi_gunung_jateng);

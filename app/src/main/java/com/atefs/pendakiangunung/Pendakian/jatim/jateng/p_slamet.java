...
public class p_slamet extends AppCompatActivity {

    private CardView myCard, myCard2, myCard3, myCard4,myCard5;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.pp_slamet);
        Toolbar toolbar = (Toolbar) findViewById(R.id.anim_toolbar);
        setSupportActionBar(toolbar);
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        CollapsingToolbarLayout collapsingToolbar = (CollapsingToolbarLayout) findViewById(R.id.collapsing_toolbar);
        collapsingToolbar.setTitle("Slamet");
        ...
        myCard5 = (CardView) findViewById(R.id.mytxtCard5);
    ...
    public void mycard5(View view) {
        myCard5.setVisibility((myCard5.getVisibility() == View.VISIBLE)
                ? View.GONE : View.VISIBLE);
    }
}
